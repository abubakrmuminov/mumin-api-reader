        ...
        <div className={cn('relative w-full max-w-xl', className)}>
            <form onSubmit={handleSearch} className="relative z-10">
                ...
                {query && (
                    ...
                    >
                        <X className="w-3 h-3 text-emerald-900/40" />
                    </button>
                )}
            </form>
            ...
            {isFocused && (
                <>
                    ...
                    />
                    <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-xl border border-emerald-900/5 overflow-hidden z-10 animate-slide-up">
                            ...
                            <div className="p-2">
                                ...
                                {history.map((item) => (
                                    <button
                                        ...
                                        className="flex items-center gap-3 w-full px-3 py-2 hover:bg-emerald-50 rounded-lg transition-colors text-left"
                                    >
                                        <History className="w-4 h-4 text-emerald-900/20" />
                                        <span className="text-sm text-emerald-950/80">{item}</span>
                                    </button>
                                ))}
                            </div>
                        )}
